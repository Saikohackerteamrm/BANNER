...
# Author 
![Screenshot](https://github.com/Saikohackerteamrm/BANNER/blob/main/20250805_145658.jpg)
...
____________________
    ...
    $ git clone https://github.com/Saikohackerteamrm/BANNER
    $ cd BANNER
    $ bash Saiko.sh
...
_______________________________________
    ...
    apt update -y && apt upgrade -y && pkg install git -y && pkg install python -y  && git clone https://github.com/Saikohackerteamrm/BANNER&& cd BANNER && bash Saiko.sh
 ### Hi there 👋
